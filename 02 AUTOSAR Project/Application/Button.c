...
{
    g_Button_Config.port_num  = BUTTON_PORT;
    g_Button_Config.pin_num   = BUTTON_PIN_NUM;
    g_Button_Config.direction = PORT_PIN_IN;
    g_Button_Config.resistor  = PULL_UP;
    g_Button_Config.initial_value  = BUTTON_RELEASED;
}
*/
/*******************************************************************************************************************/
